...
1. "[Best Yoga Mats for Beginners in 2026](/fitness/buying-guides/best-yoga-mats-for-beginners/)" (Sports / Yoga — new subcategory)

Added "Yoga" to the Sports row in `categories.md`'s active-category table, and appended the subtopic to `content-log.md`.

## Post count

**21** posts published in `_posts/` (20 prior + 1 new today).

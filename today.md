...
1. "[Best Robot Vacuums for Pet Hair Under $300 (2026)](/home-kitchen/buying-guides/best-robot-vacuums-for-pet-hair-under-300/)" (Home & Kitchen — new subcategory: Robot Vacuums)

Appended the subtopic to `content-log.md` and added "Robot Vacuums" to the Home & Kitchen row in `categories.md`.

## Post count

**27** posts published in `_posts/` (26 prior + 1 new today).

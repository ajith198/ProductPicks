...
1. "[Best Golf Rangefinders for Beginners in 2026](/golf-gear/buying-guides/best-golf-rangefinders-for-beginners/)" (Sports — new subcategory: Golf)

Appended the subtopic to `content-log.md` and added "Golf" to the Sports row in `categories.md`.

## Post count

**29** posts published in `_posts/` (28 prior + 1 new today).

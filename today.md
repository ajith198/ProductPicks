...
1. "[Best Backpacking Camp Stoves for Beginners in 2026](/outdoor-recreation/buying-guides/best-backpacking-camp-stoves-for-beginners/)" (Outdoor & Recreation / Camp Stoves — new subcategory)

Added "Camp Stoves" to the Outdoor & Recreation row in `categories.md`'s active-category table, and appended the subtopic to `content-log.md`.

## Post count

**20** posts published in `_posts/` (19 prior + 1 new today).

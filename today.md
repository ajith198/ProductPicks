...
1. "[Best Camping Coolers for Weekend Trips in 2026](/outdoor/buying-guides/best-camping-coolers-for-weekend-trips/)" (Outdoor & Recreation — new subcategory: Coolers)

Appended the subtopic to `content-log.md` and added "Coolers" to the Outdoor & Recreation row in `categories.md`.

## Post count

**32** posts published in `_posts/` (31 prior + 1 new today).

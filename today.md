...
1. "[Best Camping Chairs for Car Camping in 2026](/camp-chairs/buying-guides/best-camping-chairs-for-car-camping/)" (Outdoor & Recreation — new subcategory: Camp Chairs)

Appended the subtopic to `content-log.md` and added "Camp Chairs" to the Outdoor & Recreation row in `categories.md`.

## Post count

**36** posts published in `_posts/` (35 prior + 1 new today).

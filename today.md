...
1. "[Best Espresso Machines for Beginners in 2026](/kitchen/buying-guides/best-espresso-machines-for-beginners/)" (Home & Kitchen — new subcategory: Espresso Machines)

Appended the subtopic to `content-log.md` and added "Espresso Machines" to the Home & Kitchen row in `categories.md`.

## Post count

**31** posts published in `_posts/` (30 prior + 1 new today).

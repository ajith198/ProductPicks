...
1. "[Best Rice Cookers for Small Kitchens and Apartments in 2026](/kitchen-appliances/buying-guides/best-rice-cookers-for-small-kitchens/)" (Home & Kitchen — new subcategory: Rice Cookers)

Appended the subtopic to `content-log.md` and added "Rice Cookers" to the Home & Kitchen row in `categories.md`.

## Post count

**25** posts published in `_posts/` (24 prior + 1 new today).

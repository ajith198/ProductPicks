...
1. "[Best Basketball Shoes for Beginners in 2026](/footwear/buying-guides/best-basketball-shoes-for-beginners/)" (Sports — new subcategory: Basketball)

Appended the subtopic to `content-log.md` and added "Basketball" to the Sports row in `categories.md`.

## Post count

**30** posts published in `_posts/` (29 prior + 1 new today).

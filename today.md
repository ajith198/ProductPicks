...
1. "[Best Air Fryers for One or Two People in 2026](/kitchen/buying-guides/best-air-fryers-for-one-or-two-people/)" (Home & Kitchen / Air Fryers — new subcategory)

Added "Air Fryers" to the Home & Kitchen row in `categories.md`'s active-category table, and appended the subtopic to `content-log.md`.

## Post count

**19** posts published in `_posts/` (18 prior + 1 new today).
